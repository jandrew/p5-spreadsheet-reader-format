...
use	lib '../lib', 'lib';
BEGIN{ use_ok( Spreadsheet::Reader::Format, 0.001 ) };
BEGIN{ use_ok( Spreadsheet::Reader::Format::Types, 0.001 ) };
BEGIN{ use_ok( Spreadsheet::Reader::Format::FmtDefault, 0.001 ) };
BEGIN{ use_ok( Spreadsheet::Reader::Format::ParseExcelFormatStrings, 0.001 ) };
done_testing();