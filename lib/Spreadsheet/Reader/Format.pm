...
use version  0.77; our $VERSION = version->declare('v0.2.4');
...
<a href='https://coveralls.io/r/jandrew/p5-spreadsheet-reader-format?branch=master'>
	<img src='https://coveralls.io/repos/jandrew/p5-spreadsheet-reader-format/badge.svg?branch=master' alt='Coverage Status' />
</a>
